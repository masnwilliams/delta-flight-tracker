...
// Validate ../../src/app/api/flight/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/flight">> = Specific
  const handler = {} as typeof import("../../src/app/api/flight/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
